            ...
            <div class="d-sm-none">
                ...
                <div class="card mt-2 mb-3" id="">
                    <div class="card-header fs-16">
                        ...
                        <a href="{{ route('updatepassword.edit', $siswa) }}" class="float-right text-warning fs-16">Edit password</a>
                    </div>
                    <div class="card-body input-group-sm">
                        <form action="{{ route('siswa.update', $siswa) }}" method="POST" class="input-group-sm fs-14">
                            @csrf
                            @method('PUT')
