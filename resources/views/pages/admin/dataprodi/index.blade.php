...
@section('content')
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            ...
            <!-- Input XS -->
            <div class="d-sm-none">
                <div class="card shadow mt-2 collapse mb-3 @error(request('')) show @enderror" id="collapse">
        ...
        <div class="col-md-8 mb-xs-3">
            <div class="card shadow fs-16 mb">
                ...
                <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($prodi as $tampilkan)
                                        <tr class="border-bottom">
                                            ...
                                            <td>{{ $tampilkan->singkatan }}</td>
                                            <td class="">

                                                <a href="{{ route('prodi.edit', $tampilkan) }}" type="button"
                                                ...
                                                @if ($kelas->where('kompetensikeahlian_id', $tampilkan->id)->count() < 1)
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Data: <p class="text-primary fw-bold">
                                                                    {{ $tampilkan->name }}</p>
                                                                Data tersebut tidak dapat dihapus! Karena terdapat beberapa Kelas di <b> Prodi - {{ $tampilkan->name }} </b>  
                                                            </div>
                                                            <div class="modal-footer">
                    ...
                    @else
                        Data tidak ditemukan. <a href="{{ route('prodi.index') }}" class="">Refresh halaman</a>
                    @endif
