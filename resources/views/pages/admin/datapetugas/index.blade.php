        ...
        <div class="col-md-8 mb-xs-3">
            <div class="card shadow fs-16 ">
                <div class="card-header">
                    ...
                    <a href="{{ route('petugas.create') }}"  class="btn btn-sm float-left btn-primary d-sm-none btn-icon-split">
                                    ...
                                    @foreach ($petuga as $tampilkan)
                                        <tr class="border-bottom">
                                            ...
                                            <td class="">
                                                ...
                                                @if ($pembayaran->where('petugas_id', $tampilkan->id)->count() < 1)
                                                ...
                                                <div class="modal fade" id="modalGagalDelete/{{ $tampilkan->identifier }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Data: <p class="text-primary fw-bold">{{ $tampilkan->name . ' - ' . strtoupper($tampilkan->level) }}</p>
                                                            Data tersebut tidak dapat dihapus karena <b> PETUGAS - {{ $tampilkan->name }} </b> telah menangani beberapa transaksi!
                                                        </div>
                                                      <div class="modal-footer">
