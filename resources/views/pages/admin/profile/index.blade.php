                            ...
                            <tr class="border-bottom">
                                <div class="text-center postion-relative">
                                    ...
                                    @if ($userphoto->count() > 0)
                                        <img src="/gallery/{{ $userphoto->first()->url }}" class="img-profile mb-3 rounded-circle" alt="{{ auth()->user()->name }}" style="width: 100px; height: auto; overflow: hidden;">
                                    @else
                                        <img src="/img/profil.png" class="img-profile mb-3 rounded-circle" alt="{{ auth()->user()->name }}" style="width: 100px;">
                                    @endif

                                        <a href="{{ route('photo-user.edit') }}" class="position-absolute">
