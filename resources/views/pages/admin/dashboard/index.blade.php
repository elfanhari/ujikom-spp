...
<h5 class="mb-3 fw-bold">Data Kompetensi Keahlian</h5>
                    ...
                    <div class="row">
                        <div class="col-md-4 d-xs-none">
                            ...
                            <div class="card fs-14">
                                <div class="card-header fs-14">
                                    <p class="m-0 font-weight-bold text-primary">Input Data Prodi</p>
                                </div>
                                <div class="card-body input-group-sm">
                                    <label for="prodi" class="mb-1">Kompetensi Keahlian</label>
                                    <input type="text" name="prodi" id="prodi" class="form form-control mb-3 mt-0" placeholder="Masukkan nama kompetensi keahlian">
                                            ...
                                            <tbody>
                                              <tr class="border-bottom">
                                                ...
                                                <td class="">
                                                    ...
                                                    <button type="button" class="btn btn-success pb-1 pt-0 px-2">
                                                    ...
                                                    <button type="button" class="btn btn-primary pb-1 pt-0 px-2">
                                                    ...
                                                    <button type="button" class="btn btn-danger pb-1 pt-0 px-2">
