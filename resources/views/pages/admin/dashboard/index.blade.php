            ...
            <div class="card shadow border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fas text-secondary" width="25" height="25" fill="currentColor" class="fas fa-fw grey bi bi-buildings-fill" viewBox="0 0 16 16">
            ...
            <div class="card shadow border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fas text-secondary" width="25" height="25" fill="currentColor" class="fas fa-fw grey bi bi-building-fill" viewBox="0 0 16 16">
            ...
            <div class="card shadow border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fas text-secondary" width="25" height="25" fill="currentColor" class="grey fas fa-fw bi bi-cash-coin" viewBox="0 0 16 16">
            ...
            <div class="card shadow border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fas text-secondary" width="25" height="25" fill="currentColor" class="fas fa-fw grey bi bi-person-badge" viewBox="0 0 16 16">
            ...
            <div class="card shadow border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fas text-secondary" width="25" height="25" fill="currentColor" class="fas fa-fw grey bi bi-person-workspace" viewBox="0 0 16 16">
            ...
            <div class="card shadow border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fas text-secondary" width="25" height="25" fill="currentColor" class="fas fa-fw grey bi bi-card-checklist" viewBox="0 0 16 16">
