...
@section('content')
    <h5 class="mb-3 fw-bold poppins text-xs-center">
        <a href="{{ route('notifikasi.index') }}" class="btn btn-sm btn-outline-dark me-2">
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @else
                      <a href="{{ route('notifikasi.index') }}" class="btn btn-md btn-primary px-5 rounded-pill w-100">OK</a>
                    @endif
                </div>
            </div>
